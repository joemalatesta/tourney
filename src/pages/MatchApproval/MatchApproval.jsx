...
const MatchApproval = () => {
  ...
  const handleSubmitMatch = async (num, match) => {
    if (num === 1) {
      let winPlayer = await playerService.findOne(match[0].match1.winningPlayer._id)
      let losePlayer = await playerService.findOne(match[0].match1.losingPlayer._id)
    ...
    if (num === 2) {
      let winPlayer = await playerService.findOne(match[0].match2.winningPlayer._id)
      let losePlayer = await playerService.findOne(match[0].match2.losingPlayer._id)
    ...
    if (num === 3) {
      let winPlayer = await playerService.findOne(match[0].match3.winningPlayer._id)
      let losePlayer = await playerService.findOne(match[0].match3.losingPlayer._id)
            ...
            <div className="bracket" key={idx}>
              ...
              <div className=" row">
                <div className="bracket ">
                  ...
                  {match.length > 1 && isMatchGreen(match, 1) && submitMatch1Visible && (
                    <>
                ...
                <div className="bracket ">
                  ...
                  {match.length > 1 && isMatchGreen(match, 2)&& submitMatch2Visible && (
                ...
                <div className="bracket ">
                  ...
                  {match.length > 1 && isMatchGreen(match, 3)&& submitMatch3Visible && (
              ...
              <button onClick={()=>handleCloseMatch(match)}>Close out this match</button>
              </div>
            </div>
