      ...
      {playedData?.map((match) => (
        <li className="bracket" key={match._id}>
          ...
          <div className="row">
            ...
            <div className="bracket ">
              Match 2<br/>
              Completed : {match.match2.completed ? " YES" : " NO"}<br/>
              Winning Team : {match.match2.winningTeam==undefined? "None": match.match2.winningTeam.teamName}<br/>
              Losing Team : {match.match2.losingTeam=== undefined ? "None":match.match2.losingTeam.teamName}<br/>
              <div >
                Winning Player : {match.match2.winningPlayer === undefined? "None":match.match2.winningPlayer.name} <br/>
                Games Won : {match.match2.winnerGamesPlayed}<br/>
                Losing Player : {match.match2.losingPlayer === undefined ? "None": match.match2.losingPlayer.name} <br/>
                Games Won : {match.match2.loserGamesPlayed}<br/>
              </div>
            </div>
            <div className="bracket ">
              Match 3<br/>
              Completed : {match.match3.completed ? " YES" : " NO"}<br/>
              Winning Team : {match.match3.winningTeam==undefined? "None": match.match3.winningTeam.teamName}<br/>
              Losing Team : {match.match3.losingTeam=== undefined ? "None":match.match3.losingTeam.teamName}<br/>
              <div >
                Winning Player : {match.match3.winningPlayer === undefined? "None":match.match3.winningPlayer.name} <br/>
                Games Won : {match.match3.winnerGamesPlayed}<br/>
                Losing Player : {match.match3.losingPlayer === undefined ? "None": match.match3.losingPlayer.name} <br/>
                Games Won : {match.match3.loserGamesPlayed}<br/>
              </div>
            </div>
