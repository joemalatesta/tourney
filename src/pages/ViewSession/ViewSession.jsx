...
const ViewSession = () => {
  ...
  return (
    <>
      <div
        className="bracket row center w300"
        onClick={() => handleShowMatch(currentMatches.table1)}
      >
      ...
      <div
        className="bracket row center w300"
        onClick={() => handleShowMatch(currentMatches.table2)}
      >
        <div className="bracket">
          Table <br />2
        </div>
      ...
      <div
        className="bracket row center w300"
        onClick={() => handleShowMatch(currentMatches.table3)}
      >
        <div className="bracket">
          Table <br />3
        </div>
      ...
      <div
        className="bracket row center w300"
        onClick={() => handleShowMatch(currentMatches.table4)}
      >
        <div className="bracket">
          Table
          <br /> 4
